...
@Disabled
@Autonomous (name = "blue 3 ball back - MATCH 15", group = "Iterative Opmode")

public class blueback3v2 extends OpMode {
    ...
    private final Pose startPose = new Pose(56.00, 9.00, Math.toRadians(270));
    private final Pose lineup1 = new Pose(43.44,33.42, Math.toRadians(0));
    private final Pose intake1a = new Pose(37.50,33.34, Math.toRadians(0));
    private final Pose intake2a = new Pose(30.35, 33.34, Math.toRadians(0));
    private final Pose intake3a = new Pose(18.02, 33.34, Math.toRadians(0));
    private final Pose lineup = new Pose(42.69, 59.76, Math.toRadians(0));
    private final Pose intake1b = new Pose(35.71, 59.57, Math.toRadians(0));
    private final Pose intake2b = new Pose(30.36, 59.69, Math.toRadians(0));
    private final Pose intake3b = new Pose(18.63, 59.67, Math.toRadians(0));
    private final Pose park = new Pose(20, 9, Math.toRadians(270));

...
@Disabled
@Autonomous(name = "RED BACK - 6 RANDOM")
public class redback9 extends OpMode {
    ...
    private final Pose pickup1 = new Pose(12, 30, Math.toRadians(180));
    private final Pose pickup1a = new Pose(24, 30, Math.toRadians(180));

    private final Pose pickup1b = new Pose(28,30,Math.toRadians(180));
    private final Pose pickup1c = new Pose(35, 30, Math.toRadians(180));
    private final Pose park = new Pose(34, 68, Math.toRadians(180));

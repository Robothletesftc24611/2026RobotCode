...
@Autonomous (name = "blue 9 ball front", group = "Iterative Opmode")

public class bluefront9v2 extends OpMode {
    ...
    private final Pose startPose = new Pose(25.56, 128.00, Math.toRadians(315));
    private final Pose shootPose = new Pose(53.87, 84.23, Math.toRadians(0));
    private final Pose finalShoot = new Pose(53.87, 105.00, Math.toRadians(0));
    private final Pose intake1a = new Pose(37.13,84.20, Math.toRadians(0));
    private final Pose intake2a = new Pose(31.37, 84.20, Math.toRadians(0));
    private final Pose intake3a = new Pose(21.91, 84.20, Math.toRadians(0));
    private final Pose lineup = new Pose(42.17, 59.76, Math.toRadians(0));
    private final Pose intake1b = new Pose(36.35, 59.57, Math.toRadians(0));
    private final Pose intake2b = new Pose(31.88, 59.69, Math.toRadians(0));
    private final Pose intake3b = new Pose(23.63, 59.67, Math.toRadians(0));
    private final Pose park = new Pose(32.92, 68.80, Math.toRadians(0));

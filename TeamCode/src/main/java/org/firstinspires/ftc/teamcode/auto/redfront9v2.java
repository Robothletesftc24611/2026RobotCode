...
@Autonomous (name = "red 9 ball front", group = "Iterative Opmode")

public class redfront9v2 extends OpMode {
    ...
    private final Pose startPose = new Pose(118.44, 128.00, Math.toRadians(225));
    private final Pose shootPose = new Pose(90.13, 84.23, Math.toRadians(180));
    private final Pose finalShoot = new Pose(90.13, 105.00, Math.toRadians(180));
    private final Pose intake1a = new Pose(106.87,84.20, Math.toRadians(180));
    private final Pose intake2a = new Pose(112.63, 84.20, Math.toRadians(180));
    private final Pose intake3a = new Pose(122.09, 84.20, Math.toRadians(180));
    private final Pose lineup = new Pose(101.83, 59.76, Math.toRadians(180));
    private final Pose intake1b = new Pose(107.65, 59.57, Math.toRadians(180));
    private final Pose intake2b = new Pose(112.12, 59.69, Math.toRadians(180));
    private final Pose intake3b = new Pose(120.37, 59.67, Math.toRadians(180));
    private final Pose park = new Pose(111.08, 68.80, Math.toRadians(180));

    private PathChain scorePreload, graba1, graba2, graba3, scorea, line2, grabb1, grabb2, grabb3, scoreb, leave;
    ...
    public void buildPaths(){
        ...
        graba1 = follower.pathBuilder()
                .addPath(new BezierLine(shootPose, intake1a))
                .addParametricCallback(0.1, () -> intake.setPower(-1.0))
                .addParametricCallback(0.1, () -> door.setPosition(0.7))
        ...
        scoreb = follower.pathBuilder()
                .addPath(new BezierLine(intake3b, finalShoot))
                .addParametricCallback(0.1, () -> intake.setPower(0.0))
                .addParametricCallback(0.1, () -> door.setPosition(1.0))
                .setConstantHeadingInterpolation(Math.toRadians(180))
                .build();

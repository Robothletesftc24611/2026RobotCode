...
@Autonomous(name = "red back gate cycles", group = "COMPETITION")
public class redbackgatecycles extends OpMode {
    ...
    private static final int TURRET_START_TICKS = 317; // example: 180 degrees if 4.5 ticks/deg
    ...
    // === POSES ===
    private final Pose shootPose   = new Pose(86.75, 8.5, Math.toRadians(180));
    private final Pose pickhuman    = new Pose(130, 8.6, Math.toRadians(180));
    private final Pose backhuman    = new Pose(116, 9.1, Math.toRadians(180));
    private final Pose repick    = new Pose(130, 9.1, Math.toRadians(180));
    private final Pose gatecycle1    = new Pose(130, 15, Math.toRadians(180));
    private final Pose gatecycle1back    = new Pose(121, 14, Math.toRadians(180));
    private final Pose gatecyclerepick  = new Pose(130, 14, Math.toRadians(180));
    private final Pose finalPose   = new Pose(110, 11, Math.toRadians(180));

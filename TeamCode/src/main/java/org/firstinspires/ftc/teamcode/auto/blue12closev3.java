...
@Autonomous(name = "blue 12", group = "COMPETITION")
public class blue12closev3 extends OpMode {
    ...
    // === POSES ===
    private final Pose startPose   = new Pose(23.93, 128.46, Math.toRadians(310));
    private final Pose shootPose   = new Pose(57, 83, Math.toRadians(0));
    private final Pose finaltwo    = new Pose(18.9, 55, Math.toRadians(0));
    private final Pose control1    = new Pose(69, 52, Math.toRadians(0));
    private final Pose gatePose    = new Pose(17, 69, Math.toRadians(0));
    private final Pose control2    = new Pose(41.08, 68, Math.toRadians(0));
    private final Pose finalone    = new Pose(19, 84, Math.toRadians(0));
    private final Pose finalthree  = new Pose(18.86, 35.8, Math.toRadians(0));
    private final Pose control3    = new Pose(82, 26, Math.toRadians(0));

    private final Pose control4 = new Pose(56, 63, Math.toRadians(0));
    private final Pose finalPose   = new Pose(31.83, 68, Math.toRadians(0));
    ...
    private void updateShootFSM() {
        switch (shootState) {
            ...
            case FIRE:
                ...
                if (elapsed > 1000) shootState = ShootState.DONE;
                break;
